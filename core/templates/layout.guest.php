...
?>
		...
		<link rel="stylesheet" href="<?php print_unescaped(\OC::$WEBROOT); ?>/core/css/customstyles/layout.css">

	</head>
	<body id="<?php p($_['bodyid']);?>">
		<?php include 'layout.noscript.warning.php'; ?>
		<?php include 'layout.initial-state.php'; ?>
		<div class="wrapper" <?php if ($_['bodyid'] === 'body-login'): ?> style="padding:20px 15px 20px 15px !important;" <?php endif; ?>> <!-- ADD PADDING IN wrapper LOGIN -->
			<div class="v-align">
				<!-- ADD NEW LOGO -->
				<img src="<?php print_unescaped(image_path('core','logo/logocloudip.png')); ?>" alt="">
				<main>
