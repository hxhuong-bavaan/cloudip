...
.login-box {
	...
	border: solid rgba(0, 0, 0, 0.137) 1px;
	color: black;
	box-shadow: 0 0 10px #0621401f;
	margin-top: 25px;
	...
	@media (max-width: 480px) {
		...
		padding: 15px; // Réduction supplémentaire de l'espace interne
		margin-top: 15px; // Réduction de l'espace supérieur
	}
}
